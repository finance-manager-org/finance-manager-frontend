      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-3xl p-12 text-center space-y-8 relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div>
              <h2 className="text-white mb-4">Empieza a construir tu libertad financiera hoy</h2>
              <p className="text-blue-100 text-lg max-w-2xl mx-auto">
                Únete a miles de personas que ya están tomando control de sus finanzas. Es gratis,
                es fácil y puede cambiar tu vida.
              </p>
            </div>
