...
const steps = [
  {
    ...
    description:
      "Regístrate en segundos y configura tu perfil financiero personalizado.",
  },
  {
    icon: Plus,
    number: "02",
    ...
    description:
      "Añade tus ingresos y gastos fácilmente. Categoriza cada transacción.",
  },
  {
    icon: BarChart3,
    number: "03",
    ...
    description:
      "Analiza tus reportes, identifica patrones y toma decisiones inteligentes.",
  },
];
