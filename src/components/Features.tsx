    ...
    <section className="px-4 py-20 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="text-center space-y-4 mb-16">
          <h2 className="text-slate-900">Todo lo que necesitas para gestionar tu dinero</h2>
          <p className="text-slate-600 max-w-2xl mx-auto">
            Herramientas poderosas y fáciles de usar diseñadas para ayudarte a alcanzar tus metas
            financieras
          </p>
        </div>
