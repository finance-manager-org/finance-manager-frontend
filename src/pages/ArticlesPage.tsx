...
const articles = [
  {
    ...
    excerpt: "Descubre métodos probados para incrementar tus ahorros sin sacrificar tu calidad de vida. Aprende a construir un fondo de emergencia sólido.",
  ...
  },
  {
    ...
    excerpt: "Un presupuesto bien estructurado es la base de la salud financiera. Aprende a crear uno que realmente funcione para ti y tu estilo de vida.",
  ...
  },
  {
    ...
    excerpt: "El crédito puede ser una herramienta poderosa o una trampa financiera. Aprende a utilizarlo de manera estratégica para construir tu patrimonio.",
  ...
  },
  {
    ...
    excerpt: "Descubre cómo nuestra plataforma simplifica la gestión de tus finanzas personales y te ayuda a alcanzar tus metas económicas más rápido.",
    date: "9 de Noviembre, 2025",
    readTime: "4 min",
    icon: Zap,
...
export function ArticlesPage() {
  ...
  const article = selectedArticle !== null 
      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8 md:p-12">
            ...
            {/* Call to Action */}
            <div className={`mt-12 p-6 bg-gradient-to-r ${article.color} rounded-xl`}>
              <h3 className="text-2xl font-bold text-white mb-2">
                ¿Listo para tomar el control de tus finanzas?
              </h3>
              <p className="text-white/90 mb-4">
                Empieza hoy mismo con Finance Manager y transforma tu futuro financiero.
              </p>
              <Link to="/register">
