...
export default function LoginPage() {
  ...
  const { goToHome , goToRegister} = useRedirect();
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl p-6 border border-slate-200 space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-slate-900 mb-1">Tu información te espera</div>
                  <p className="text-slate-600 text-sm">
                    Accede a tus reportes, gráficos y análisis financieros actualizados.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <p className="text-center text-xs text-slate-500 mt-4">
              Tus credenciales están protegidas con encriptación de nivel bancario
            </p>
          </div>
        </div>
      </div>
